...
<body>
<div class="loc">
  <div class="icon">当前位置：安装工程师列表</div>
</div>
<span class="con2">
<input name="button2" id="button2" value="添加工程师" class="blue" onclick="location.href='addErector'" type="button">
<br>
<br>
</span>
<table class="bgg" bgcolor="#cccccc" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <#if list??>
    ...
    <tr class="con">
        ...
        <td align="center" bgcolor="#FFFFFF">安装工</td>
