...
<body>
<div class="loc">
  <div class="icon">当前位置：供应商管理员列表</div>
</div>
<span class="con2">
<input name="button2" id="button2" value="添加供应商" class="blue" onclick="location.href='addSupplier'" type="button">
<br>
<br>
</span>
<table class="bgg" bgcolor="#cccccc" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <#if list??>
    ...
    <tr class="con">
        ...
        <td align="center" bgcolor="#FFFFFF">供应商管理员</td>
